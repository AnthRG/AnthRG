...
- Builders de agentes **local-first** con **MCP** y pipelines de documentos
- Visión por computadora (CNN / deep learning) en dominio médico
...
- **SSO / Identity Provider** propio: JWT, revocación de sesión, auditoría
- Patrones multi-DB (relacional + documental en un mismo sistema)
...
- Bases de datos **clínicas / médicas** y cumplimiento regulatorio
...
- **Marketplaces multi-vendor**, monorepos (Bun + Turbo) y APIs type-safe (tRPC)
